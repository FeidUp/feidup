...
export default function Home() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[hsl(43,47%,95%)] to-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-[family-name:var(--font-fredoka)] text-gray-900 mb-6 leading-tight">
                ...
                <span className="text-[hsl(14,86%,57%)]">High-Visibility</span>{" "}
                Ad Inventory
              </h1>
        ...
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 -z-10 w-96 h-96 bg-[hsl(14,86%,57%)] opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 -z-10 w-96 h-96 bg-[hsl(14,86%,57%)] opacity-5 rounded-full blur-3xl"></div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[hsl(43,47%,95%)] to-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
      ...
      <section className="py-24 bg-gradient-to-r from-[hsl(14,86%,57%)] to-[hsl(14,86%,47%)]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button href="/about" className="bg-white/10 border-2 border-white text-white hover:bg-white hover:text-[hsl(14,86%,57%)]">
              Learn More
            </Button>
          </div>
        </div>
